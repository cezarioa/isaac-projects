"""Clean static room physics opinions directly from the USDA root layer.

This reaches unloaded ``over`` specs inside payload children that
Usd.Stage.Traverse() may not visit when remote payloads are unavailable.
"""
...
print("Layer-spec static room cleanup:")
...
if not removed_schemas and not removed_attrs:
    print("  No remaining static physics opinions found in root layer.")
